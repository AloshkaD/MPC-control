// Part of this code was adopted from CarND-MPC-Quizzes solution on 
...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs) {
  ...
  // Steering angel
  //I converted the upper and lower values for the sttering from -25 to 25 into radiance 
  ...
  // from quiz solution, keep initial values 
